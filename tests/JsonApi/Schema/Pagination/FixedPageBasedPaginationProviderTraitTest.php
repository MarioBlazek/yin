...
class FixedPageBasedPaginationProviderTraitTest extends TestCase
{
    ...
    public function getSelfLinkWhenPathIsProvided(): void
    {
        ...
        self::assertSame('https://example.com/api/users?page%5Bnumber%5D=1', $href);
    }
    ...
    public function getSelfLinkWhenPathAndAdditionalQueryStringIsProvided(): void
    {
        ...
        self::assertSame('https://example.com/api/users?a=c&b=d&page%5Bnumber%5D=1', $href);
    }
    ...
    public function getSelfLinkWhenPathWithQueryStringIsProvided(): void
    {
        ...
        self::assertSame('https://example.com/api/users?a=b&page%5Bnumber%5D=1', $href);
    }
    ...
    public function getLastLink(): void
    {
        ...
        self::assertSame('https://example.com/api/users?page%5Bnumber%5D=5', $href);
    }
    ...
    public function getPrevLinkWhenPageIsLast(): void
    {
        ...
        self::assertSame('https://example.com/api/users?page%5Bnumber%5D=4', $href);
    }
    ...
    public function getNextLink(): void
    {
        ...
        self::assertSame('https://example.com/api/users?page%5Bnumber%5D=3', $href);
    }
