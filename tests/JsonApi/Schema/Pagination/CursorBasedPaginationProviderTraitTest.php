...
class CursorBasedPaginationProviderTraitTest extends TestCase
{
    ...
    public function getSelfLinkWhenOnlyPathProvided(): void
    {
        ...
        self::assertSame('https://example.com/api/users?page%5Bcursor%5D=2&page%5Bsize%5D=10', $href);
    }
    ...
    public function getSelfLinkWhenQueryStringIsProvided(): void
    {
        ...
        self::assertSame('https://example.com/api/users?a=b&page%5Bcursor%5D=2&page%5Bsize%5D=10', $href);
    }
    ...
    public function getSelfLinkWhenPathAndAdditionalQueryStringIsProvided(): void
    {
        ...
        self::assertSame('https://example.com/api/users?a=c&b=d&page%5Bcursor%5D=2&page%5Bsize%5D=10', $href);
    }
    ...
    public function getFirstLink(): void
    {
        ...
        self::assertSame('https://example.com/api/users?page%5Bcursor%5D=0&page%5Bsize%5D=10', $href);
    }
    ...
    public function getLastLink(): void
    {
        ...
        self::assertSame('https://example.com/api/users?page%5Bcursor%5D=4&page%5Bsize%5D=10', $href);
    }
    ...
    public function getNextLink(): void
    {
        ...
        self::assertSame('https://example.com/api/users?page%5Bcursor%5D=3&page%5Bsize%5D=10', $href);
    }
